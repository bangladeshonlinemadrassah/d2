...
<body>
  ...
  <div id="main-page" style="display: none;">
    <header>
      <nav class="nav container">
        ...
        <div class="controls">
          ...
          <a class="btn" id="add-class-btn" href="https://docs.google.com/forms/d/e/1FAIpQLScxUYNsEFpE3YA9DBA7GtDadTJ3TXJd9-xgKesRlOrVrjvj1w/viewform?usp=header" target="_blank" rel="noopener" style="display: none;"><i class="fas fa-plus-circle"></i> <span class="bangla-font">ক্লাস যুক্ত করুন</span></a>
        </div>
      </nav>
    </header>
    ...
    <div class="owner-wrap">
      <div class="owner-sub2">বাংলাদেশ অনলাইন মাদ্রাসা (BOM) এর প্রতিষ্ঠাতা এবং দূরদর্শী নেতা, যিনি শিক্ষার্থীদের উৎকর্ষের পথে পরিচালিত করছেন।</p></div>
...
<div id="notification" class="notification"></div>
  <script>
    // আপনার মূল JavaScript কোড এখানে রাখুন
    // এটি অপরিবর্তিত রাখা হয়েছে কারণ আপনি শুধুমাত্র CSS পরিবর্তন চেয়েছিলেন
